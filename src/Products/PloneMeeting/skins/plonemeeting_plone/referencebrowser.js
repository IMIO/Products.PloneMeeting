  ...
  function check_referenced_items(fieldname) {
      var refs_in_overlay = jq('input.insertreference'),
          ...
          current_uids = current.map(function () {
              // XXX begin of change by PloneMeeting, to be removed when https://github.com/plone/archetypes.referencebrowserwidget/pull/15 merged
              //if (jq(this).attr('checked') === true) {
              if (this.checked === true) {
              // XXX end of change by PloneMeeting
