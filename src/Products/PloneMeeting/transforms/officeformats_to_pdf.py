...
class officeformats_to_pdf(commandtransform):
    """
      This transform use appy.pod converter and OpenOffice in server mode
      to transform any Office formats (MS Office or OpenOffice) to PDF
    """
