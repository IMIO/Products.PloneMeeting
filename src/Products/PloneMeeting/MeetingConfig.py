...
schema = Schema((
    ...
    DataGridField(
        ...
        widget=DataGridField._properties['widget'](
            ...
            columns={'signatureNumber': SelectColumn("Signature number", vocabulary="listSignatureNumbers", col_description="Select the signature number."), 'name': Column("Name", col_description="Name of the signatory (for example 'Mister John Doe')."), 'function': Column("Function", col_description="Function (for example 'Mayor')."), 'date_from': Column("Valid from (included)", col_description="Enter valid from date, use following format : YYYY/MM/DD, leave empty so it is always valid."), 'date_to': Column("Valid to (included)", col_description="Enter valid to date, use following format : YYYY/MM/DD, leave empty so it is always valid."), },
