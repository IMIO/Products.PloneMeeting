...
from Products.PloneMeeting.content.meeting_config import CONFIGGROUPPREFIX
from Products.PloneMeeting.content.meeting_config import PROPOSINGGROUPPREFIX
from Products.PloneMeeting.content.meeting_config import READERPREFIX
from Products.PloneMeeting.content.meeting_config import SUFFIXPROFILEPREFIX
        ...
        if cached is not None:
            ...
            if not cfg:
                ...
                if IMeeting.providedBy(context):
                    ...
                    resultsperpagedefault = cfg.max_shown_listings
