...
- Enable plone.app.caching :
  ...
  - cache is invalidated when context/cfg/linkedmeeting changed.  Adapted code so every changes in external elements of the MeetingConfig
    (faceted settings, subfolders, recurring items, collections, ...) notifyModified MeetingConfig;
