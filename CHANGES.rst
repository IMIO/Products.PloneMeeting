...
- In asynchronous tasks (change completeness/emergency/listType/toDiscuss), use utils.notifyModifiedAndReindex instead
  MeetingItem._update_after_edit that does to much (full reindex, updateLocalRoles).  But make change to listType notify ObjectEditedEvent because it can be used in the item reference
